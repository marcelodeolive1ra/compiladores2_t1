...
public interface LAListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterVariavel_registro(LAParser.Variavel_registroContext ctx);
	/**
	 * Exit a parse tree produced by {@link LAParser#variavel_registro}.
	 * @param ctx the parse tree
	 */
	void exitVariavel_registro(LAParser.Variavel_registroContext ctx);
	/**
	 * Enter a parse tree produced by {@link LAParser#mais_var_registro}.
	 * @param ctx the parse tree
	 */
	void enterMais_var_registro(LAParser.Mais_var_registroContext ctx);
	/**
	 * Exit a parse tree produced by {@link LAParser#mais_var_registro}.
	 * @param ctx the parse tree
	 */
	void exitMais_var_registro(LAParser.Mais_var_registroContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterIdent_param(LAParser.Ident_paramContext ctx);
	/**
	 * Exit a parse tree produced by {@link LAParser#ident_param}.
	 * @param ctx the parse tree
	 */
	void exitIdent_param(LAParser.Ident_paramContext ctx);
	/**
	 * Enter a parse tree produced by {@link LAParser#mais_id_param}.
	 * @param ctx the parse tree
	 */
	void enterMais_id_param(LAParser.Mais_id_paramContext ctx);
	/**
	 * Exit a parse tree produced by {@link LAParser#mais_id_param}.
	 * @param ctx the parse tree
	 */
	void exitMais_id_param(LAParser.Mais_id_paramContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterChamada(LAParser.ChamadaContext ctx);
	/**
	 * Exit a parse tree produced by {@link LAParser#chamada}.
	 * @param ctx the parse tree
	 */
	void exitChamada(LAParser.ChamadaContext ctx);
	/**
