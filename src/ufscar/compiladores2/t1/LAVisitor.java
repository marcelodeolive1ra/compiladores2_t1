...
public interface LAVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitVariavel_registro(LAParser.Variavel_registroContext ctx);
	/**
	 * Visit a parse tree produced by {@link LAParser#mais_var_registro}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMais_var_registro(LAParser.Mais_var_registroContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIdent_param(LAParser.Ident_paramContext ctx);
	/**
	 * Visit a parse tree produced by {@link LAParser#mais_id_param}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMais_id_param(LAParser.Mais_id_paramContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitChamada(LAParser.ChamadaContext ctx);
	/**
	 * Visit a parse tree produced by {@link LAParser#atribuicao}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAtribuicao(LAParser.AtribuicaoContext ctx);
	/**
